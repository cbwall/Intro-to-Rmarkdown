...
`fig.height=3, fig.width=3` This will format your figure to be 3x3
...
use `#` for headings, `#`.... `####` and so on.  # is largest and #### smallest heading

Two forms for *italics* and _italics_  and  **bold** and __bold__ to modiy text  
  
Superscript superscript^2^ or strikethroughs  ~~strikethrough~~  
  
add links [R studio link](www.rstudio.com)  
...
![Pa'āni is *beautiful* and **(sassy)**](data/Paani.jpg){ width=15% }  
...
![](data/M cap bleached.jpg){ width=50% }


**Figure 1.** This is a figure of a bleached *Montipora capitata* coral during the 2014 bleaching event in Kāne'ohe Bay, O'ahu, Hawai'i. (PC: CB Wall)
