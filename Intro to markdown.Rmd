...
```{r, fig.show='hold', out.width= "50%", fig.cap="**FIGURE EXAMPLE** *Side-by-side plots at 50% with a 'fig hold' option*"}
...
![Pa'āni is *beautiful* (and **sassy**)](data/Paani.jpg){ width=30%}  
...
```{r chlorophyll a figure, results='hide', fig.cap="*Figure 3. Chlorophyll a density. Caption set in code chunk setting*"}
