...
```{r, fig.show='hold', out.width= "50%", fig.align='center', fig.cap="*Figure 1. Example of side-by-side plots at 50% with a 'fig hold' option*"}
...
```{r, results="hide", fig.dim=c(5,3), fig.align='center', fig.cap="**Figure 2**. Tissue biomass in two coral species."}
...
```{r chlorophyll a figure, results='hide', fig.align='center', fig.cap="**Figure 5**. Chlorophyll a density. Caption set in code chunk setting"}
...
```{r, results='hide', fig.height=4, fig.width=4, fig.align='center', fig.cap="**Figure 6.** Boxplot of square-root transformed chlorophyll *a* data"}
mean(chla.transform)
