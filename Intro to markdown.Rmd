...
```{r, fig.show='hold', out.width= "50%", fig.align='center', fig.cap="**Figure 4. Example of side-by-side plots at 50%, with a 'fig hold' option**"}
data<-read.csv("data/coral_data.csv")
...
plot(density(MC.df$biomass), lwd=2, col="darksalmon", xlim=c(0,100), main="Figure 5. Tissue biomass in two coral species", cex.main=0.8, xlab=expression(paste("Biomass", ~(mg~cm^-2), sep="")))
...
```{r, results='hide', fig.height=4, fig.width=4, fig.align='center', fig.cap="**Figure 7. Boxplot of chlorophyll *a* data**"}
...
```{r, fig.height=4, fig.width=8, fig.align='center', fig.cap="**Figure 8. Boxplot of chlorophyll *a* data by physiological state**"}
par(mfrow=c(1,2))
