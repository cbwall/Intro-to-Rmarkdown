...
# you can use:    install.packages("package name") if you don't have them already in your library
...
#### First, Git and R Projects  
My first advise to you would be to set up a [GitHub account](https://github.com/). Having a GitHub allows you to have all your code, markdown, figures, data, etc archived online for safety and version control. You can make these repositories private or collaborative. It is easy! There are a lot of resources out there on why/how to use GitHub, and you'll see why it is important as you advance your carpentry--you can [read about how painless this](http://happygitwithr.com/big-picture.html).
...
![**Data Directory example**](data/directory example.jpg){ width=30%}
...
```{r chlorophyll a figure, results='hide', fig.align='center', fig.cap="**Figure** Chlorophyll a density. *This caption was set in code chunk setting*"}
...
```{r, results='hide', fig.height=4, fig.width=4, fig.align='center', fig.cap="Boxplot of chlorophyll *a* data"}
mean(chla)
...
```{r, fig.height=4, fig.width=8, fig.align='center', fig.cap="Boxplot of chlorophyll *a* data by physiological state"}
par(mfrow=c(1,2))
